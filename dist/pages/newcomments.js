...
exports.default = withData_1.default(function (props) { return (React.createElement(MainLayout_1.default, { currentURL: props.url.pathname },
    React.createElement(NewsFeed_1.default, { newsItems: SampleData_1.default.newsItems, first: 30, skip: 0, currentURL: props.url.pathname }))); });
//# sourceMappingURL=newcomments.js.map