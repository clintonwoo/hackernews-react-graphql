  ...
  <BlankLayout>
    ...
    >
      <span style={spanStyle}>
        Y Combinator has adopted the following policy toward copyright infringement on the Services
      ...
      <span style={spanStyle}>
        , the "<b>DMCA</b>"). The address of Y Combinator's Designated Agent for copyright takedown
        notices ("
    ...
    <p className="MsoNormal" style={paragraphStyle2}>
      <span style={spanStyle}>
        ...
        (“Services”) infringes a copyright, please send a written notice (by fax or regular mail) to
        ...
        misrepresent that material is infringing your copyright(s). Please use the following format
    ...
    <ol style={{ marginTop: '0in' }} start={1} type="1">
      ...
      <li className="MsoNormal" style={liStyle}>
        <span style={liSpanStyle}>
          ...
          accurate and that the Notifying Party is either the copyright owner, or authorized to make
    ...
    <p className="MsoNormal" style={paragraphStyle2}>
      <span style={spanStyle}>
        ...
        Subscriber responsible for the allegedly infringing material that it has removed or disabled
        access to the material. Y Combinator reserves the right, in its sole discretion, to
        immediately terminate the account of any Subscriber who is the subject of repeated DMCA
        notifications.
      </span>
    </p>
    ...
    <ul style={{ listStyleType: 'disc', marginTop: '0in' }}>
      ...
      <li className="MsoNormal" style={liStyle}>
        <span style={liSpanStyle}>
          ...
          judicial district in which your address is located (or the federal district courts located
          in San Francisco, CA if your address is outside of the United States), and that you will
          accept service of process from the person who provided the original DMCA notification or
    ...
    <p className="MsoNormal" style={paragraphStyle2}>
      <span style={spanStyle}>
        ...
        copyright holder he or she represents) will then have ten (10) days to notify us that he or
        she has filed legal action relating to the allegedly infringing material. If Y Combinator
        does not receive any such notification within ten (10) days, we may restore the material to
        the Services.
      </span>
    </p>
