...
export const NewsWelcomePage: React.FC = () => (
  <NoticeLayout>
    ...
    <p>
      ...
      gossip about famous people, funny or cute pictures or videos, partisan political articles,
      etc. If you let{' '}
      <a href="http://en.wikipedia.org/wiki/Nile_perch">
        that sort of thing onto a news site, it will push aside the deeply interesting stuff, which
        tends to be quieter.
      </a>
    </p>
    <p>
