...
export const ShowHNRulesPage = () => (
  <Notice>
    ...
    <p>
      Show HN is for something you've made that other people can play with. HN users can try it out, give you feedback,
    ...
    <p>
      If your work isn't ready for people to try out yet, please don't do a Show HN. Once it's ready, come back and do
      it then.
    </p>
    <p>Blog posts, sign-up pages, and fundraisers can't be tried out, so they can't be Show HNs.</p>
    <p>
      New features and upgrades ("Foo 1.3.1 is out") generally aren't substantive enough to be Show HNs. A major
      overhaul is probably ok.
    </p>
    <p>
      <b>In Comments</b>
    </p>
